...
#define CONFIG_APP_VERSION_PATCH 1
...
#define CONFIG_SC_TASK_STACK_SIZE 4096
#define CONFIG_SC_TASK_PRIORITY 3
#define CONFIG_SC_MAX_OBSERVERS 3
#define CONFIG_SC_AUTO_SAVE_WIFI 1
#define CONFIG_SC_AUTO_RECONNECT 1
#define CONFIG_SC_SET_AP_MAC 1
